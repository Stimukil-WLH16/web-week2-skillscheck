...
// Create a function called 'sum' that takes in two parameters, 'num1' and 'num2'. The function should return the sum
...
// parameter is even or odd. If the parameter is odd, return 'the number is odd'. If the number is even, 
...
// Create a function called 'iLove' that takes in two string parameters, 'name' and 'love'. Have the function take 
// the two parameters and return a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in 
// the string. e.g. "Joseph loves music"
...
// Below is an array, myNumbers. You will be using .map, .filter, .reduce and .forEach to manipulate the array in the 
// following problems.
...
// Code Here
let total = muNumbers.reduce(function(acc, curr){
	return acc + curr
});
//////////////////PROBLEM 17////////////////////
